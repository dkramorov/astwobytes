...
urlpatterns = [
    ...
    url('^admin/(?P<ftype>flatmenu|flatmain|flatpages|flattemplates)/(?P<container_id>[0-9]{1,11})/(?P<action>edit|drop|copy|img)/(?P<row_id>[0-9]{1,11})/$', views.edit_block, name='edit_block'),
