# Generated by Django 2.2.3 on 2020-01-23 20:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('freeswitch', '0004_cdrcsv'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='cdrcsv',
            options={'verbose_name': 'Freeswitch - Звонок', 'verbose_name_plural': 'Freeswtich - Звонки'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('context', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('cid', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('callgroup', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
