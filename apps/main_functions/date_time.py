...
regas_date = (
    (re.compile('^([0-9]{1,2}-[0-9]{1,2}-[0-9]{4})\s([0-9]{1,2}:[0-9]{1,2}:[0-9]{1,2})$'), '%d-%m-%Y %H:%M:%S'),
    (re.compile('^([0-9]{4}-[0-9]{1,2}-[0-9]{1,2})\s([0-9]{1,2}:[0-9]{1,2}:[0-9]{1,2})$'), '%Y-%m-%d %H:%M:%S'),
    (re.compile('^([0-9]{4}-[0-9]{1,2}-[0-9]{1,2})\s([0-9]{1,2}:[0-9]{1,2})$'), '%Y-%m-%d %H:%M'),
    (re.compile('^([0-9]{1,2}-[0-9]{1,2}-[0-9]{4})\s([0-9]{1,2}:[0-9]{1,2})$'), '%d-%m-%Y %H:%M'),
...
def weekdayToStr(date, rp=None, socr=None):
    """День недели прописью
       rp - Родительный падеж (кого, чего)"""
...
def monthToStr(date, rp=None, socr=None):
    """Месяц прописью
       rp - Родительный падеж (кого, чего)"""
    months = (('', '', ''),
                 ('Январь', 'января', 'янв'),
