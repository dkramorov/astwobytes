...
$(document).ready(function(){
  ...
  $(".costs_types").change(function(){
    var current_price = $(this).attr("data-cost");
    var current_cost_type = $(this).attr("data-cost_type_id");
    var product_id = $(this).attr("data-product_id")
    $(".product_price_" + product_id).html('<span class="sale text-color-dark">' + current_price + '</span>');
  });
});
