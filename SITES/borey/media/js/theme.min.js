...
{key:"addClassnames",value:function t(){var i=this.options;s.length&&s.addClass("vc_row pp-section pp-auto-height"),i.navigation&&this.$body.addClass("lqd-stack-has-nav"),i.prevNextButtons&&this.$body.addClass("lqd-stack-has-prevnext-buttons"),i.pageNumber&&this.$body.addClass("lqd-stack-has-page-numbers"),"none"!==i.effect&&this.$body.addClass("lqd-stack-effect-enabled"),this.$body.addClass("lqd-stack-effect-".concat(i.effect)),this.$body.add("html").addClass("overflow-hidden"),e("html").addClass("pp-enabled")}},

{key:"eachSection",value:function t(){var i=this;e.each(this.$sections,(function(e,t){i.wrapInnerContent(t),i.makeScrollable(t),i.setSectionsLuminance(t),i.setAnchors(e,t),i.setTooltips(e,t)}))}},{key:"wrapInnerContent",value:function t(i){e(i).wrapInner('<div class="lqd-stack-section-inner" />')}},

{key:"makeScrollable",value:
  function t(i){
    var n=e(i),a;
...
{key:"setAnchors",value:function e(t,i){
console.log(i);
...
{key:"setTooltips",value:function e(t,i){i.hasAttribute("data-tooltip")?this.tooltips[t]=i.getAttribute("data-tooltip"):this.tooltips[t]="".concat(this.options.defaultTooltip," ").concat(t+1)}},

{key:"setSectionsLuminance",value:function t(i){var n=e(i),a=this.$element.css("backgroundColor"),s=n.css("backgroundColor")||a||"#fff";i.hasAttribute("data-section-luminance")?this.sectionsLuminance.push(n.attr("data-section-luminance")):this.sectionsLuminance.push(tinycolor(s).getLuminance()<=.5?"dark":"light")}},
...
{key:"init",value:function e(){
  ...
  this.$element.pagepiling({
    ...
    css3:a,
    scrollingSpeed:s,
    loopTop:o,loopBottom:r,
    animateAnchor:c,navigation:l,
...
{key:"appendPrevNextButtons",value:function t(){
var i=this.options.prevNextLabels;this.$prevNextButtons=e('<div class="lqd-stack-prevnext-wrap" />');var n=e('<button class="lqd-stack-prevnext-button lqd-stack-prev-button">\n\t\t\t\t<span class="lqd-stack-button-labbel">'.concat(i.prev,'</span>\n\t\t\t\t<span class="lqd-stack-button-ext">\n\t\t\t\t\t<svg width="36px" height="36px" class="lqd-stack-button-circ" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000">\n\t\t\t\t\t\t<path d="M17.89548,35.29096 C27.5027383,35.29096 35.29096,27.5027383 35.29096,17.89548 C35.29096,8.28822168 27.5027383,0.5 17.89548,0.5 C8.28822168,0.5 0.5,8.28822168 0.5,17.89548 C0.5,27.5027383 8.28822168,35.29096 17.89548,35.29096 Z"></path>\n\t\t\t\t\t</svg>\n\t\t\t\t\t<svg width="36px" height="36px" class="lqd-stack-button-circ lqd-stack-button-circ-clone" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000">\n\t\t\t\t\t\t<path d="M17.89548,35.29096 C27.5027383,35.29096 35.29096,27.5027383 35.29096,17.89548 C35.29096,8.28822168 27.5027383,0.5 17.89548,0.5 C8.28822168,0.5 0.5,8.28822168 0.5,17.89548 C0.5,27.5027383 8.28822168,35.29096 17.89548,35.29096 Z"></path>\n\t\t\t\t\t</svg>\n\t\t\t\t\t<svg xmlns="http://www.w3.org/2000/svg" class="lqd-stack-button-arrow" width="12.5px" height="13.5px" viewbox="0 0 12.5 13.5" fill="none" stroke="#000">\n\t\t\t\t\t\t<path d="M11.489,6.498 L0.514,12.501 L0.514,0.495 L11.489,6.498 Z"/>\n\t\t\t\t\t</svg>\n\t\t\t\t</span>\n\t\t\t</button>')),a=e('<button class="lqd-stack-prevnext-button lqd-stack-next-button">\n\t\t\t\t<span class="lqd-stack-button-labbel">'.concat(i.next,'</span>\n\t\t\t\t<span class="lqd-stack-button-ext">\n\t\t\t\t\t<svg width="36px" height="36px" class="lqd-stack-button-circ" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000">\n\t\t\t\t\t\t<path d="M17.89548,35.29096 C27.5027383,35.29096 35.29096,27.5027383 35.29096,17.89548 C35.29096,8.28822168 27.5027383,0.5 17.89548,0.5 C8.28822168,0.5 0.5,8.28822168 0.5,17.89548 C0.5,27.5027383 8.28822168,35.29096 17.89548,35.29096 Z"></path>\n\t\t\t\t\t</svg>\n\t\t\t\t\t<svg width="36px" height="36px" class="lqd-stack-button-circ lqd-stack-button-circ-clone" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000">\n\t\t\t\t\t\t<path d="M17.89548,35.29096 C27.5027383,35.29096 35.29096,27.5027383 35.29096,17.89548 C35.29096,8.28822168 27.5027383,0.5 17.89548,0.5 C8.28822168,0.5 0.5,8.28822168 0.5,17.89548 C0.5,27.5027383 8.28822168,35.29096 17.89548,35.29096 Z"></path>\n\t\t\t\t\t</svg>\n\t\t\t\t\t<svg xmlns="http://www.w3.org/2000/svg" class="lqd-stack-button-arrow" width="12.5px" height="13.5px" viewbox="0 0 12.5 13.5" fill="none" stroke="#000">\n\t\t\t\t\t\t<path d="M11.489,6.498 L0.514,12.501 L0.514,0.495 L11.489,6.498 Z"/>\n\t\t\t\t\t</svg>\n\t\t\t\t</span>\n\t\t\t</button>'));this.$prevNextButtons.append(n.add(a)),!this.$body.children(".lqd-stack-prevnext-wrap").length&&this.$body.append(this.$prevNextButtons)}},

{key:"prevNextButtonsEvents",value:function t(){var i=this.$prevNextButtons.find(".lqd-stack-prev-button"),n=this.$prevNextButtons.find(".lqd-stack-next-button");i.on("click",(function(){e.fn.pagepiling.moveSectionUp()})),n.on("click",(function(){e.fn.pagepiling.moveSectionDown()}))}},

{key:"appendPageNumber",value:function t(){var i=this.$sections.not(".main-footer").length;this.$pageNumber=e('<div class="lqd-stack-page-number" />');var n=e('<span class="lqd-stack-page-number-counter">\n\t\t\t\t<span class="lqd-stack-page-number-current"></span>\n\t\t\t\t<span class="lqd-stack-page-number-passed"></span>\n\t\t\t</span>'),a=e('<span class="lqd-stack-page-number-total">'.concat(i<10?"":"").concat(i,"</span>"));this.$pageNumber.append(n),this.$pageNumber.append(a),!this.$body.children(".lqd-stack-page-number").length&&this.$body.append(this.$pageNumber)}},{key:"setPageNumber",value:function e(t){var i=this.$pageNumber.find(".lqd-stack-page-number-current"),n;this.$pageNumber.find(".lqd-stack-page-number-passed").html(i.html()),i.html("".concat(t<10?"":"").concat(t))}},

{key:"addDirectionClassname",value:function e(t){"down"==t?this.$body.removeClass("lqd-stack-moving-up").addClass("lqd-stack-moving-down"):"up"==t&&this.$body.removeClass("lqd-stack-moving-down").addClass("lqd-stack-moving-up")}},

{key:"addLuminanceClassnames",value:function e(t){this.$body.removeClass("lqd-stack-active-row-dark lqd-stack-active-row-light").addClass("lqd-stack-active-row-".concat(this.sectionsLuminance[t]))}},

{key:"initShortcodes",value:function t(i){e("[data-custom-animations]",i).liquidCustomAnimations(),i.is("[data-custom-animations]")&&i.liquidCustomAnimations(),e("[data-dynamic-shape]",i).liquidDynamicShape(),e("[data-reveal]",i).liquidReveal(),e("[data-particles=true]",i).liquidParticles()}},

{key:"initBackToTop",value:function t(i){i>1?this.$backToTopButton.addClass("is-visible"):this.$backToTopButton.removeClass("is-visible"),e("a",this.$backToTopButton).on("click",(function(t){t.preventDefault(),e.fn.pagepiling.moveTo(1)}))}},

{key:"afterRender",value:function t(){this.$body.addClass("lqd-stack-initiated"),this.$ppNav=e("#pp-nav"),s.length&&(this.$ppNav.find("li").last().addClass("hide"),this.$body.addClass("lqd-stack-has-footer")),this.initShortcodes(this.$sections.first()),this.addLuminanceClassnames(0),this.options.prevNextButtons&&this.appendPrevNextButtons(),this.options.prevNextButtons&&this.prevNextButtonsEvents(),this.options.pageNumber&&this.appendPageNumber(),this.options.pageNumber&&this.setPageNumber(1)}},

{key:"onLeave",value:function t(i,n,a){var s=e(this.$sections[n-1]),o=e(this.$sections[i-1]);s.is(".main-footer")||o.is(".main-footer")?o.is(".main-footer")&&o.addClass("lqd-stack-row-leaving"):(this.$body.addClass("lqd-stack-moving"),this.setPageNumber(n),s.removeClass("lqd-stack-row-leaving").addClass("lqd-stack-row-entering"),o.removeClass("lqd-stack-row-entering").addClass("lqd-stack-row-leaving"),this.addLuminanceClassnames(n-1)),s.is(".main-footer")?(this.$body.addClass("lqd-stack-footer-active"),o.css("transform","none")):this.$body.removeClass("lqd-stack-footer-active"),this.addDirectionClassname(a),this.initShortcodes(s),this.$backToTopButton.length&&this.initBackToTop(n)}},

{key:"afterLoad",value:function t(i,n){e(this.$sections).removeClass("lqd-stack-row-entering lqd-stack-row-leaving"),this.$body.removeClass("lqd-stack-moving lqd-stack-moving-up lqd-stack-moving-down")}}]),t}();e.fn[a]=function(t){return this.each((function(){var i=e(this).data("stack-options")||t;e.data(this,"plugin_"+a)||e.data(this,"plugin_"+a,new r(this,i))}))}}(jQuery,window,document),
