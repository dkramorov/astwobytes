(function($){
	jQuery.fn.philmegamenu = function(options){
		var settings;
		$.extend( settings = {
			trigger: "hover",
			showDelay: 0,
    ...
    // Настроить якорные ссыли
    function setup_anchors(){
      $(".primary-menu-menu > li > a, .primary-menu ul.dropdown li a").each(function(){
        ...
        $(this).bind("click touchstart", function(e){
          ...
          if($(this).hasClass('custom-open-aside')){
            e.stopPropagation();
            PHIL.togglePanel();
